...
public class IsoAppletToken implements Token {
    ...
    private static final Log log = LogFactory.getLog(IsoAppletToken.class);
//2018-04-06 10:33:56.160 ATR     : 3b:9f:96:80:3f:c7:a2:80:31:e0:73:fe:21:1b:64:08:67:41:40:82:90:00:2d

    public static final ATR ISOAPPLET_ATR =
        new ATR(new byte[] {
                (byte) 0x3B, (byte) 0x9F, (byte) 0x96, (byte) 0x80,
                (byte) 0x3F, (byte) 0xC7, (byte) 0xA2, (byte) 0x80,
                (byte) 0x31, (byte) 0xE0, (byte) 0x73, (byte) 0xFE,
                (byte) 0x21, (byte) 0x1B, (byte) 0x64, (byte) 0x08,
                (byte) 0x67, (byte) 0x41, (byte) 0x40, (byte) 0x82,
                (byte) 0x90, (byte) 0x00, (byte) 0x2d
                });
     ...
     */
    public IsoAppletToken(CardChannel channel) {
        super();
...
//        dos.write(acl.getAcDecrease());
        ...
        // CREATE FILE, P1=0x00, P2=0x00, ID -> read current EF from position 0.
        CommandAPDU cmd = new CommandAPDU(0x00,0xE0,0x00,0x00,data);
    ...
    public InputStream readEFData() throws IOException {
        ...
        CommandAPDU cmd = new CommandAPDU(0x00,0xB0,0x00,0x00,0x100);
    ...
    public MF selectMF() throws IOException {
        CommandAPDU cmd = new CommandAPDU(0x00, 0xA4, 0x04, 0x0C, aid);

        try {
            ResponseAPDU resp = this.channel.transmit(cmd);
            cmd = new CommandAPDU(0x00, 0xA4, 0x00, 0x04, new byte[] { 0x3f, 0x00 } );
            resp = this.channel.transmit(cmd);
            DataInputStream dis = getSelectFileData(resp);
    ...
    public DF selectParentDF() throws IOException {
        ...
        CommandAPDU cmd = new CommandAPDU(0x00,0xA4,0x03,0x00,0x100);
